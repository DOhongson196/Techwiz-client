...
export const DarkIcon = () => (
  <svg viewBox="0 0 24 24" fill="none" className="w-8 h-8 group">
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
export const LeftIcon = ({ width = '3rem', height = '3rem', className }) => (
...
export const RightIcon = ({ width = '3rem', height = '3rem', className }) => (
  <svg
    className={className}
    width={width}
    height={height}
